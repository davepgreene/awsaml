...
function Configure() {
  ...
  if (auth) return <Navigate to="/refresh" />;
  if (selectRole) return <Navigate to="/select-role" />;
      ...
      <Row>
        <RoundedCenteredDivColumnWrapper>
          ...
          <RoundedCenteredDivColumnContent>
            ...
            <ConfigureMetadata setError={setError} setMetadataUrlValid={setMetadataUrlValid} />
            <RecentLogins errorHandler={errorHandler} />
          </RoundedCenteredDivColumnContent>
        </RoundedCenteredDivColumnWrapper>
      </Row>
    </Container>
